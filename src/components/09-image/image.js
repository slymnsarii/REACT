...
const Image = () => {
  return (
    <div>
      ...
      url olarak gelir öyle kullanırız burda
      */}
      <img
      ...
      Frontend kısmında logo gibi sabit kalacak fotoğraflar olur, onları asset içinde tutarız ve statik,import,require yöntemlerini
      kullanarak yaparız
      */}
